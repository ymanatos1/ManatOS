...
export function setRuntimeConfiguration(name: string, value: string | undefined) {
  if (value === undefined) values.delete(name);
  else values.set(name, value);
}
export function runtimeString(name: string, fallback: string): string {
...
export function runtimeBoolean(name: string, fallback: boolean): boolean {
